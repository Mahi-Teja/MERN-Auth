  ...
  return (
    <div>
      ...
      <div className="max-w-lg mx-auto flex flex-col">
        ...
        {user?.email ? <InputField value={user?.email} type={"text"} /> : null}
        <InputField type={"text"} lable={"change password"} value={""} />
        <SubmitButton lable={"Update"} />
        <div className="flex justify-between">
          <SubmitButton lable={"Delete Account"} className={"bg-red-900"} />
          <Logout />
        </div>
      </div>
      {/* <p>{user.userId}</p> */}
